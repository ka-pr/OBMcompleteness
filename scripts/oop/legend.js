...
function Legend(style, prefix)
{
  if (!style) {
    style = new Style();
    console.warn('no style definition submitted. creating legend object with default style', style);
  }
...
{
  // console.log('... legend style param', style);
  var _legend = this;
  ...
  L.Control.Legend = L.Control.extend ({
    ...
    onAdd: function (map) {
      map.legend = this;
      var div = L.DomUtil.create('div', 'info '+_legend._prefix+'_legend_whole');
      div.id = 'legend';
      ...
      console.log('style def', style_def);
