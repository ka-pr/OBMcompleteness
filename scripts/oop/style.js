 ...
 * @param {Function} display_feature_upon a function that maps a property value to another string value
 * @example
 ...
 */
function Style(layer_style, feature_name, feature_style, callback, display_feature_upon=function(x){return x;})
{
  ...
  // console.log('...', this);
  /* function to map a value to another string */
  this._display_feature_upon = display_feature_upon;
}
...
Style.prototype.callback = function(e)
{
  if (this._callback && typeof this._callback === "function") {
    ...
    console.error('error', 'no callback function or callback function is of wrong type', this._callback);
  }
};
